...
// var recipeQueryURL = "https://api.edamam.com/search?q=chicken&app_id=0c8956d4&app_key=f6e0fb536a06a548b0e38056ceba81fa";
...
$("#submit-btn").on("click", function () {
    $("#step1-recipe").fadeIn("slow"); 
    $("#step2-recipe").fadeIn("slow"); 
})